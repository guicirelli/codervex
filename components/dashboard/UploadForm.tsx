...
export default function UploadForm({ onPromptGenerated, user }: UploadFormProps) {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      // Usar endpoint normal (stream será implementado depois se necessário)
  ...
  return (
    <div className="card">
      <h2 className="text-2xl font-bold text-gray-900 mb-6">Enviar Projeto</h2>
      ...
      <div className="mb-6 p-4 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg">
        <div className="flex items-start">
          <Github className="w-5 h-5 text-blue-600 dark:text-blue-400 mr-2 mt-0.5 flex-shrink-0" />
          <div className="text-sm text-blue-800 dark:text-blue-200">
            <p className="font-semibold mb-1">💡 Integração GitHub em breve</p>
            <p>Por enquanto, faça upload de arquivos ou arquivo ZIP do seu projeto. A integração com GitHub será lançada em breve!</p>
          </div>
        </div>
      </div>
